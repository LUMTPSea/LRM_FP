...
# 似乎是没啥用的参数
    ...
    agents = [
        nfsp_lonr_arm_off_policy.NFSP_LONR(device, idx, info_state_size, num_actions, hidden_layers_sizes, checkpoint_dir, args) 
            for idx in range(num_players)
    ]
    expl_policies_avg = NFSPPolicies(env, agents, nfsp_lonr_arm_off_policy.MODE.best_response)
