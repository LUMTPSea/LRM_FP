...
flags.DEFINE_integer("learn_every",  128, "Number of steps between learning updates.")
...
def main(unused_argv):
    ...
    absolute_dir = "./dqn_experiments/leduc"
    checkpoint_dir = os.path.join(absolute_dir, FLAGS.results_dir, "tmp")
