...
def main():
    ...
    parser.add_argument('--results_dir', type=str, default="simple_default", help="log direction of nfsp-lonr experiments")
    ...
    parser.add_argument('--sl_learning_rate', type=float,default=0.01, help="Learning rate for avg-policy sl network.")
    parser.add_argument('--rl_q_learning_rate', type=float,default=1e-3, help="Learning rate for inner rl q network learning rate.")
    parser.add_argument('--rl_pi_learning_rate', type=float,default=1e-3, help="Learning rate for inner rl pi network learning rate.")
    ...
    parser.add_argument('--update_target_network_every', type=int, default=int(1000), help="update_target_network_every")
    ...
    absolute_dir = "./kuhn_nfsp_lonr_no_pi_no_greedy_maxq"
